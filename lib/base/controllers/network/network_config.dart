...
class NetworkConfig {
  ...
  final _base = 'https://6176555a03178d00173dab77.mockapi.io/';
  ...
  Future<Response> post({
    ...
    return _dio!.post(
      ...
      options: cash ? _buildCacheOptions(
          headers: headers, forceRefresh: forceRefresh, body: body) : Options(headers: headers) ,
    );
  }
